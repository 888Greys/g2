  ...
  return (
    <>
      ...
      <Section
        ...
        actionHref="/catalog?sort=trending"
        className="bg-white"
      >
      ...
      <Section
        ...
        actionHref="/catalog?sort=bestsellers"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-gradient-to-r from-blue-900 to-indigo-900 rounded-2xl overflow-hidden shadow-xl relative group">
          ...
          <div className="relative p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <Link
              to="/signup"
              className="bg-orange-500 text-white px-8 py-4 rounded-xl font-bold text-lg hover:bg-orange-600 transition-colors shadow-lg shadow-orange-500/20 whitespace-nowrap"
            >
